...
/**
 * WebimsMemgroupnodeViewId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class WebimsMemgroupnodeViewId implements java.io.Serializable {
	...
	/** default constructor */
	public WebimsMemgroupnodeViewId() {
	}

	/** full constructor */
	public WebimsMemgroupnodeViewId(Integer nodeId, Integer memgroupsiteId) {
		this.nodeId = nodeId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebimsMemgroupnodeViewId))
			return false;
		WebimsMemgroupnodeViewId castOther = (WebimsMemgroupnodeViewId) other;
