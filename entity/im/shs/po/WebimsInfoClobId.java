...
/**
 * WebimsInfoClobId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class WebimsInfoClobId implements java.io.Serializable {
	...
	/** default constructor */
	public WebimsInfoClobId() {
	}

	/** minimal constructor */
	public WebimsInfoClobId(Integer infoId, String key) {
		this.infoId = infoId;
		this.key = key;
	}

	/** full constructor */
	public WebimsInfoClobId(Integer infoId, String key, String value) {
		this.infoId = infoId;
		this.key = key;
		this.value = value;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebimsInfoClobId))
			return false;
		WebimsInfoClobId castOther = (WebimsInfoClobId) other;
