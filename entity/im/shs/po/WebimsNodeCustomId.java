...
/**
 * WebimsNodeCustomId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class WebimsNodeCustomId implements java.io.Serializable {
	...
	/** default constructor */
	public WebimsNodeCustomId() {
	}

	/** minimal constructor */
	public WebimsNodeCustomId(Integer nodeId, String key) {
		this.nodeId = nodeId;
		this.key = key;
	}

	/** full constructor */
	public WebimsNodeCustomId(Integer nodeId, String key, String value) {
		this.nodeId = nodeId;
		this.key = key;
		this.value = value;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebimsNodeCustomId))
			return false;
		WebimsNodeCustomId castOther = (WebimsNodeCustomId) other;
