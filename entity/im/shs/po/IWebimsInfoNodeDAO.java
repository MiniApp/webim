...
/**
 * Interface for WebimsInfoNodeDAO.
 * @author MyEclipse Persistence Tools
 */

public interface IWebimsInfoNodeDAO {
	/**
	...
	*   IWebimsInfoNodeDAO.save(entity);
	...
	*/
	 ...
	 * <pre>
	 *   EntityManagerHelper.beginTransaction();
	 *   IWebimsInfoNodeDAO.delete(entity);
	 *   EntityManagerHelper.commit();
	 *   entity = null;
	 * </pre>
	 ...
	 * <pre>
	 *   EntityManagerHelper.beginTransaction();
	 *   entity = IWebimsInfoNodeDAO.update(entity);
	 *   EntityManagerHelper.commit();
	 * </pre>
	...
	*/
	 ...
	 */
	public List<WebimsInfoNode> findAll(int... rowStartIdxAndCount);
}